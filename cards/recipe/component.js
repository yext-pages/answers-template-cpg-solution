{{> cards/card_component componentName='recipe' }}

class recipeCardComponent extends BaseCard['recipe'] {
  constructor(config = {}, systemConfig = {}) {
    super(config, systemConfig);
    this.setTemplate(`{{{read 'cards/recipe/template' }}}`);
  }
  ...
  dataForRender(profile) {
    return {
      ...
      listItems: profile.c_ingredients,
      subtitle: profile.c_preparationTime + ' | ' + profile.c_servings,
...
ANSWERS.registerComponentType(recipeCardComponent);